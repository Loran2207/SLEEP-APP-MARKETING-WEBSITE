    ...
    <div>
      <div className="flex flex-col gap-2.5">
        <button
          ...
          className="flex h-13 w-full items-center justify-center rounded-full bg-white transition-[transform,opacity] duration-150 hover:opacity-90 active:scale-[0.99] motion-reduce:transform-none motion-reduce:transition-none"
        >
          <ApplePayMark className="h-[21px] w-auto" />
        </button>
        ...
        <button
          ...
          className="flex h-13 w-full items-center justify-center rounded-full bg-[#ffc439] transition-[transform,opacity] duration-150 hover:opacity-90 active:scale-[0.99] motion-reduce:transform-none motion-reduce:transition-none"
        >
