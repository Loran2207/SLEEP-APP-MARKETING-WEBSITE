...
export const funnelCopy = {
  ...
  socialProof: {
    leadBefore: "Sleep members win back at least ",
    leadStrong: "2 hours of rest",
    leadAfter: " every night.",
    titleBefore: "You're in good hands. Join ",
    titleAccent: "100k+ happy people",
    titleAfter: " already sleeping better",
    bodyBefore: "Focus on what truly matters to you, and ",
    bodyAccent: "leave the falling asleep to us",
    bodyAfter: ".",
    tagline: "Just let it happen. Rest easy.",
    primary: "Sounds good!",
  },
  comparison: {
